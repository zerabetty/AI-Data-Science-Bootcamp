...
agg_df["customers_level_based"] = [
    f"{row[0]}_{row[1]}_{row[2]}_{row[3]}".upper()
...
prediction_1 = agg_df[agg_df["customers_level_based"] == user_1]
print("\n--- Tahmin 1 (Türk Kadın) ---")
print(prediction_1)
...
prediction_2 = agg_df[agg_df["customers_level_based"] == user_2]
print("\n--- Tahmin 2 (Fransız Kadın) ---")
print(prediction_2)