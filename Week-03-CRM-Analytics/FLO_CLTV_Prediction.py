...
def replace_with_thresholds(dataframe, variable):
    ...
    if dataframe[variable].dtype != 'float64':
...
print(cltv_df.sort_values(by="exp_sales_3_month", ascending=False).head(10))

print("\n--- 6 Ayda En Çok Satın Alma Beklenen 10 Müşteri ---")
print(cltv_df.sort_values(by="exp_sales_6_month", ascending=False).head(10))
# 2.  Gamma-Gamma modelini fit ediniz. Müşterilerin ortalama bırakacakları değeri tahminleyip exp_average_value olarak cltv dataframe'ine ekleyiniz.
...
cltv = ggf.customer_lifetime_value(bgf,
                                   ...
                                   cltv_df['T_weekly'],
                                   cltv_df['monetary_cltv_avg'],
                                   time=6,  # Ay cinsinden süre
                                   freq="W",  # T ve Recency'nin haftalık (Weekly) olduğunu belirtiyoruz
                                   discount_rate=0.01) # Opsiyonel indirim oranı
...
segment_analysis.columns = [
    'recency_weekly_mean', 'T_weekly_mean', 'frequency_mean',
    'monetary_avg_mean', 'cltv_mean', 'customer_count'
]
